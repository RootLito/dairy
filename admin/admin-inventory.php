                    ...
                    <?php else: ?>
                        <?php foreach ($products as $product): ?>
                            <tr>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="product<?php echo $product['product_id']; ?>Check">
                                        <label class="form-check-label" for="product<?php echo $product['product_id']; ?>Check"></label>
                                    </div>
                                </td>
                                <td>#<?php echo $product['product_id']; ?></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo $product['product_image']; ?>" class="rounded me-3" alt="Product Image" width="60" height="60">
                                        <div>
                                            <div class="fw-medium"><?php echo $product['product_name']; ?></div>
                                            <div class="small text-muted">SKU: <?php echo $product['sku']; ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <input type="number" class="form-control form-control-sm stock-input" value="<?php echo $product['initial_stock']; ?>" min="0" data-product-id="<?php echo $product['product_id']; ?>" style="width: 80px;">
                                </td>
                                <td><span class="badge <?php echo $product['is_active'] ? 'bg-success' : 'bg-danger'; ?>"><?php echo $product['is_active'] ? 'Active' : 'Inactive'; ?></span></td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button" id="productActionDropdown<?php echo $product['product_id']; ?>" data-bs-toggle="dropdown" aria-expanded="false">
                                            Actions
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="productActionDropdown<?php echo $product['product_id']; ?>">
                                            <li><a class="dropdown-item" href="edit_product.php?product_id=<?php echo $product['product_id']; ?>"><i class="fas fa-edit me-2"></i>Edit</a></li>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <div class="input-group">
                <input type="number" class="form-control" id="productWeight" name="productWeight" min="0" step="0.01">
                <select class="form-select" id="weightUnit" name="weightUnit" style="max-width: 100px;">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="productTags" name="productTags" placeholder="organic, fresh, local">
        </div>
    </div>

    <div class="form-check form-switch mb-3">
        <input class="form-check-input" type="checkbox" role="switch" id="productStatus" name="productStatus" checked>
