                ...
                <div class="col-md-6 col-lg-5">
                    <div class="card shadow-sm mb-5">
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">Login as Admin</h4>
                        ...
                        <div class="card-body p-4">
                            <p class="text-muted mb-4">Welcome back! Please enter your credentials to access your shop account.</p>
                            ...
                            <div class="text-center mt-4">
                                <p class="mb-0">Don't have a shop account? <a href="admin-register.php" class="text-decoration-none">Register here</a></p>
                            </div>
