    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <i class="fas fa-store me-2"></i>DairyMart
            </a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="categoriesDropdown">
                            <li><a class="dropdown-item" href="#milk">Milk</a></li>
                            <li><a class="dropdown-item" href="#cheese">Cheese</a></li>
                            <li><a class="dropdown-item" href="#yogurt">Yogurt</a></li>
                            <li><a class="dropdown-item" href="#butter">Butter & Cream</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="#specialty">Specialty Products</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                            ...
                            <li>
                                <form method="post" class="m-0">
                                    <button type="submit" name="logout" class="dropdown-item btn btn-link d-flex align-items-center p-0 text-start w-100">
